...
EntityDustBunny = ig.Entity.extend({
	...
	update: function(){
		...
		*/
		...
		if(this.direction == 'left')
		{
			if(this.standing && (this.vel.x == 0 || this.pos.x <= this.xleft) ) //if hits range edge or wall
			{
		...
		{
			if(this.standing && (this.vel.x == 0 || this.pos.x >= this.xright) ) // if hits range edge or wall
			{
